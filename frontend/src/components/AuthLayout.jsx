  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-green-200 via-white to-blue-200 flex flex-col">
      <header className="py-8 text-center">
        <span className="text-4xl font-extrabold text-green-800 tracking-tight">PayProX</span>
      ...
      <footer className="py-4 text-center text-xs text-gray-400">© {new Date().getFullYear()} PayProX</footer>
    </div>
  );
}
